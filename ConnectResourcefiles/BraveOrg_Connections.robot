...
${login_url}              https://brave-wolf-hcwlsf-dev-ed.lightning.force.com            # Salesforce instance. NOTE: Should be overwritten in CRT variables
...
Login
    ...
    TypeText              Password                    ${BravePassword}
    ClickText             Log In
